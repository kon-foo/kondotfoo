...
enableToc: true
unlisted: false
title: "[latest] Vue.js GPT"
date: 2023-11-15
---
<img src="https://raw.githubusercontent.com/luona-dev/latestGPTs/main/assets/vuejs/logo_vuegpt.png" width="96" alt="Icon of the Vue3 GPTs" style="float: left; margin-right: 10px;">
...
| ----------------------------------------------------------------------------- | ------- | ------------- | ------------------------- |
| [[latest] Vue.js GPT](https://chat.openai.com/g/g-LXEGvZLUS-l-vue3-gpt)       | 3.4.5   | 2024-01-05    | 😍                        |
...
Unfortunately, OpenAI currently only displays 4 of these conversation starters on desktop and 2 on mobile respectively. [Leave us feedback](https://github.com/luona-dev/latestGPTs?tab=readme-ov-file#contribution-guidelines) or create an issue if you want your favorite preset among the first two that are displayed.
