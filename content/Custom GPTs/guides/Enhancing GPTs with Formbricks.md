...
![Formbricks Survey Creation Tool](https://raw.githubusercontent.com/luona-dev/latestGPTs/main/assets/guides/formbricks-in-gpts/formbricks-survey-creation-tool.png)
...
To make our lifes easier, I created a Python script that will come in handy. You can find it [here](https://raw.githubusercontent.com/luona-dev/latestGPTs/main/assets/guides/formbricks-in-gpts/formbricks_to_gpt.py). It handles three purposes:
...
This will create a `surveys_oapi.json` file that should comply with OpenAIs requirements for custom GPT actions. If you did not use the script to generate the `surveys.json` file, you can have a look at the [`example_surveys_oapi.json`](https://raw.githubusercontent.com/luona-dev/latestGPTs/main/assets/guides/formbricks-in-gpts/example_surveys_oapi.json) and copy and paste your IDs into it. Read the following section in case you run into any problems.
...
[Over here](https://raw.githubusercontent.com/luona-dev/latestGPTs/main/assets/guides/formbricks-in-gpts/example_surveys_instructions.md) you can find a set of example instructions for a `/vote`, `/feedback` and `/rate` command. 
